...
<head>
  <meta charset="utf-8">
    ...
    <title>multilingual Ecommerce</title>
							...
							<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" :value="old('email')" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="User Email" required autofocus>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" required autocomplete="current-password">
									</div>
								</div>
                                <div class="row">
                                    <div class="col-6">
