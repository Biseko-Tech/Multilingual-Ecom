                    ...
                    <div class="col">
                        <form action="{{ route('admin.profile.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">						
                                    <div class="form-group">
                                        <img id="showImage" src="{{ (!empty($editData->profile_photo_path)) ? url('upload/admin-images/'.$editData->profile_photo_path) : url('upload/default.jpg') }}" alt="image" style="width: 80px; height: 80px;">
                                    </div>
                                </div>
                            </div>
